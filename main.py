...
{CY}[1]{WT}  Login / Ganti Akun
{CY}[2]{WT}  Lihat Paket Saya
{CY}[3]{RD}  🔥 Beli Paket HOT
{CY}[4]{RD}  🔥 Beli Paket HOT-2
{CY}[5]{WT}  Beli Paket via Option Code
{CY}[6]{WT}  Beli Paket via Family Code
{CY}[7]{WT}  Auto-Buy Semua Paket di Family Code
{CY}[8]{WT}  Riwayat Transaksi
{CY}[9]{WT}  Family Plan / Akrab Organizer
{CY}[10]{WT} Circle
{CY}[11]{WT} Store Segments
{CY}[12]{WT} Store Family List
{CY}[13]{WT} Store Packages
{CY}[14]{WT} Redeemables

{GR}[R]{WT}  Register
{GR}[N]{WT}  Notifikasi
{GR}[V]{WT}  Validate MSISDN

{YE}[00]{WT} Bookmark Paket
{RD}[99]{WT} Keluar Aplikasi
